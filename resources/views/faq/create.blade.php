    ...
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                <h6 class="m-0 font-weight-bold text-primary">FAQ Management</h6>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('faq.create') }}"
                            class="{{ request()->routeIs('faq.create') ? 'active' : '' }}">Create FAQ</a>
                    </li>
                </ol>
            </div>
...
@push('scripts')
    <!-- jQuery & Bootstrap JS (Summernote dependency) -->
    ...
    <script>
        $(document).ready(function() {
            $('#answer').summernote({
                height: 200,
                toolbar: [
                    // Customize toolbar, tanpa tombol upload image
                    ...
                    ['height', ['height']],
                    ['insert', ['link']], // no image upload button here

                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-end mb-4">
                        ...
                        @can('faq.create')
                            <div class="d-flex flex-column flex-sm-row align-items-start justify-content-start mt-3 mt-sm-0">
                                <a href="{{ route('faq.create') }}" class="btn btn-sm btn-primary shadow-sm">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let editUrl = `/master-management/faq/${data}/edit`;
                            let showUrl = `/master-management/faq/${data}`;
                            let deleteUrl = `/master-management/faq/${data}`;
                            return `

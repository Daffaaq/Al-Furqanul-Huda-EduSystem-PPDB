...
@section('content')
    <div class="container-fluid">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="d-flex justify-content-between">
                    ...
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('jadwal-pendaftaran.edit', $jadwalPendaftaran->id) }}"
                                class="{{ request()->routeIs('jadwal-pendaftaran.edit') ? 'active' : '' }}">
            ...
            <div class="card-body">
                <!-- Jadwal Pendaftaran Edit Form -->
                <form method="POST" action="{{ route('jadwal-pendaftaran.update', $jadwalPendaftaran->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_jadwal_pendaftaran" id="nama_jadwal_pendaftaran"
                                    ...
                                    value="{{ old('nama_jadwal_pendaftaran', $jadwalPendaftaran->nama_jadwal_pendaftaran) }}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="periode_id" id="periode_id"
                                    ...
                                    @foreach ($periode as $p)
                                        <option value="{{ $p->id }}"
                                            {{ old('periode_id', $jadwalPendaftaran->periode_id) == $p->id ? 'selected' : '' }}>
                                            {{ $p->nama_periode }}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_mulai_jadwal_pendaftaran"
                                    ...
                                    value="{{ old('tanggal_mulai_jadwal_pendaftaran', $jadwalPendaftaran->tanggal_mulai_jadwal_pendaftaran) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_selesai_jadwal_pendaftaran"
                                    ...
                                    value="{{ old('tanggal_selesai_jadwal_pendaftaran', $jadwalPendaftaran->tanggal_selesai_jadwal_pendaftaran) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="gelombang_pendaftaran" id="gelombang_pendaftaran"
                                    ...
                                    value="{{ old('gelombang_pendaftaran', $jadwalPendaftaran->gelombang_pendaftaran) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="deadline_biodata_calon_siswa" id="deadline_biodata_calon_siswa"
                                    ...
                                    value="{{ old('deadline_biodata_calon_siswa', $jadwalPendaftaran->deadline_biodata_calon_siswa) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_mulai_verifikasi" id="tanggal_mulai_verifikasi"
                                    ...
                                    value="{{ old('tanggal_mulai_verifikasi', $jadwalPendaftaran->tanggal_mulai_verifikasi) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="tanggal_selesai_verifikasi" id="tanggal_selesai_verifikasi"
                                    ...
                                    value="{{ old('tanggal_selesai_verifikasi', $jadwalPendaftaran->tanggal_selesai_verifikasi) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="deadline_upload_pendaftaran" id="deadline_upload_pendaftaran"
                                    ...
                                    value="{{ old('deadline_upload_pendaftaran', $jadwalPendaftaran->deadline_upload_pendaftaran) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="pengumuman_hasil_seleksi" id="pengumuman_hasil_seleksi"
                                    ...
                                    value="{{ old('pengumuman_hasil_seleksi', $jadwalPendaftaran->pengumuman_hasil_seleksi) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="kuota_pendaftaran" id="kuota_pendaftaran"
                                    ...
                                    value="{{ old('kuota_pendaftaran', $jadwalPendaftaran->kuota_pendaftaran) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="kuota_penerimaan" id="kuota_penerimaan"
                                    ...
                                    value="{{ old('kuota_penerimaan', $jadwalPendaftaran->kuota_penerimaan) }}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="kuota_akun" id="kuota_akun"
                                    ...
                                    value="{{ old('kuota_akun', $jadwalPendaftaran->kuota_akun) }}">
                                @error('kuota_akun')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="col-md-6 text-center">
                            <div class="form-group">
                                ...
                                <select name="status_jadwal_pendaftaran" id="status_jadwal_pendaftaran"
                                    ...
                                    <option value="Opened"
                                        {{ old('status_jadwal_pendaftaran', $jadwalPendaftaran->status_jadwal_pendaftaran) == 'Opened' ? 'selected' : '' }}>
                                        Opened
                                    </option>
                                    <option value="Ongoing"
                                        {{ old('status_jadwal_pendaftaran', $jadwalPendaftaran->status_jadwal_pendaftaran) == 'Ongoing' ? 'selected' : '' }}>
                                        Ongoing
                                    </option>
                                    <option value="Closed"
                                        {{ old('status_jadwal_pendaftaran', $jadwalPendaftaran->status_jadwal_pendaftaran) == 'Closed' ? 'selected' : '' }}>
                                        Closed
                                    </option>
                                </select>

        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between align-items-center">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('bobot-pendaftaran.create') }}"
                            class="{{ request()->routeIs('bobot-pendaftaran.create') ? 'active' : '' }}">
                            Tambah Bobot Pendaftaran
                        </a>
                    </li>
                </ol>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function sendFormData(bobotAkademik, bobotNonAkademik) {
            ...
            formData.append('periode_id', document.getElementById('periode_id').value);
            formData.append('bobot_akademik', bobotAkademik);
            formData.append('bobot_non_akademik', bobotNonAkademik);
            formData.append('_token', '{{ csrf_token() }}');

            fetch('{{ route('bobot-pendaftaran.store') }}', {
                    method: 'POST',
                    body: formData,
                })

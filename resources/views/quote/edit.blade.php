                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('quote.edit', $quote->id) }}"
                            class="{{ request()->routeIs('quote.edit') ? 'active' : '' }}">
                            Edit Quote
                        </a>
                    </li>
                </ol>
                ...
                <form method="POST" action="{{ route('quote.update', $quote->id) }}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="quotes" id="quotes" rows="3" class="form-control @error('quotes') is-invalid @enderror"
                            placeholder="Masukkan kutipan...">{{ old('quotes', $quote->quotes) }}</textarea>
                        @error('quotes')
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="author" id="author"
                            ...
                            value="{{ old('author', $quote->author) }}" placeholder="Nama pengarang">
                        @error('author')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <select name="periode_id" id="periode_id"
                            ...
                            @foreach ($periodelist as $periode)
                                <option value="{{ $periode->id }}"
                                    {{ old('periode_id', $quote->periode_id) == $periode->id ? 'selected' : '' }}>
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('quote.index') }}" class="btn btn-secondary mr-2">Cancel</a>
